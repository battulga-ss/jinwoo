...
export type QuestWhereInput = {
  ...
  reward?: Prisma.XOR<Prisma.RewardCompositeFilter, Prisma.RewardObjectEqualityInput>
...
export type QuestOrderByWithRelationInput = {
  ...
  reward?: Prisma.RewardOrderByInput
...
export type QuestCreateInput = {
  ...
  status?: $Enums.QuestStatus
  type: $Enums.QuestType
  reward: Prisma.XOR<Prisma.RewardCreateEnvelopeInput, Prisma.RewardCreateInput>
...
export type QuestUpdateInput = {
  ...
  reward?: Prisma.XOR<Prisma.RewardUpdateEnvelopeInput, Prisma.RewardCreateInput>
...
export type RewardObjectEqualityInput = {
  xp: number
  str: number
  agi: number
  int: number
...
export type QuestOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "title" | "status" | "type" | "reward" | "userId" | "completedAt" | "createdAt", ExtArgs["result"]["quest"]>
...
export interface QuestDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  /**
   * Find zero or more Quests that matches the filter.
   * @param {QuestFindRawArgs} args - Select which filters you would like to apply.
   * @example
   * const quest = await prisma.quest.findRaw({
   *   filter: { age: { $gt: 25 } }
   * })
   */
  findRaw(args?: Prisma.QuestFindRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>

  /**
   * Perform aggregation operations on a Quest.
   * @param {QuestAggregateRawArgs} args - Select which aggregations you would like to apply.
   * @example
   * const quest = await prisma.quest.aggregateRaw({
   *   pipeline: [
   ...
   * })
   */
  aggregateRaw(args?: Prisma.QuestAggregateRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>
 ...
 * Quest findRaw
 */
export type QuestFindRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
 ...
 * Quest aggregateRaw
 */
export type QuestAggregateRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
